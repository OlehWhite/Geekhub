...
var validMethodName = function (arrayWords, callbackToUpperCaseFirstLetter) {
  return arrayWords
    .map(function (string) {
      return callbackToUpperCaseFirstLetter(string);
    })
    .join("");
};
...
var validMethodNumber = function (arrayNumbers, callbackMultiply) {
  return arrayNumbers
    .map(function (number) {
      return callbackMultiply(number);
    })
    .join();
};
...
var validMethodObject = function (arrayObj, callbackNameAndAge) {
  return arrayObj
    .map(function (element) {
      return callbackNameAndAge(element);
    })
    .join();
};
...
var validMethodReturnElement = function (
  arrayElements,
  callbackReverseElement
) {
  return arrayElements
    .map(function (element) {
      return callbackReverseElement(element);
    })
    .join();
};
...
getElementHeight(); //25
var convertToObject = function (number) {
  return { value: number, isOdd: Boolean(number % 2) };
};
convertToObject(10); // { value: 10, isOdd: false }
var minus = function (firstNumber) {
  if (firstNumber === void 0) {
    firstNumber = 0;
  }
  return function (secondNumber) {
    if (secondNumber === void 0) {
      secondNumber = 0;
    }
...
var multiply = multiplyMarker(function (num) {
  return num * 2;
});
multiply(2); // 4
multiply(3); // 12
